...
#ifndef kDevice_Is_iPhone6
#define kDevice_Is_iPhone6 ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(750, 1334), [[UIScreen mainScreen] currentMode].size) : NO)
#endif

#ifndef kDevice_Is_iPhone6Plus
...
+ (CGSize)badgeSizeWithStr:(NSString *)badgeValue font:(UIFont *)font{
    ...
    //            font = [UIFont htmi_systemFontOfSize:12];
    //        }else{
    //            font = [UIFont htmi_systemFontOfSize:11];
    //        }
    //    }
    
    //wangliquan update 2017/08/04
    CGSize badgeSize = CGSizeZero;//[badgeValue getSizeWithFont:font constrainedToSize:CGSizeMake(kMaxBadgeWith, 20)];
...
- (void)commonInitialization {
    ...
    _badgeBackgroundColor = [UIColor whiteColor];//[UIColor colorWithHexString:@"0xf75388"];
